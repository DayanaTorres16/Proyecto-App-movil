...
class PeliculaEndGameActivity: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_pelicula_endgame)
    }
    ...
    fun openDescargarEndgame(view: View) {
        val intent = Intent(this, DescargarEndgameActivity::class.java).apply { }
        startActivity(intent)
    }
    fun openEstrellaEndgame(view: View) {
        val intent = Intent(this, EstrellaEndgameActivity::class.java).apply { }
        startActivity(intent)
    }
}