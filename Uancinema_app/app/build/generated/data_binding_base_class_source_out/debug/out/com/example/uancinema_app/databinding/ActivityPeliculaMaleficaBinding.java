...
public final class ActivityPeliculaMaleficaBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario17;
  ...
  private ActivityPeliculaMaleficaBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario17, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario17 = imageButtonUsuario17;
  ...
  @NonNull
  public static ActivityPeliculaMaleficaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPeliculaMaleficaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_pelicula_malefica, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPeliculaMaleficaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario17;
      ImageButton imageButtonUsuario17 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario17 == null) {
        break missingId;
      }
      ...
      return new ActivityPeliculaMaleficaBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario17, imageView7, textView8, textView9);
    }
