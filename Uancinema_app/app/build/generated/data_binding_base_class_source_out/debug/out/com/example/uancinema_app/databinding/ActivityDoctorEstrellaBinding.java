...
public final class ActivityDoctorEstrellaBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario7;
  ...
  private ActivityDoctorEstrellaBinding(@NonNull ConstraintLayout rootView, @NonNull Button button5,
      ...
      @NonNull ImageButton imageButtonUsuario7, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario7 = imageButtonUsuario7;
  ...
  @NonNull
  public static ActivityDoctorEstrellaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDoctorEstrellaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_doctor_estrella, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDoctorEstrellaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario7;
      ImageButton imageButtonUsuario7 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario7 == null) {
        break missingId;
      }
      ...
      return new ActivityDoctorEstrellaBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario7, imageView7, textView8, textView9);
    }
