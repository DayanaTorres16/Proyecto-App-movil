...
public final class ActivityRatatouilleDescargaBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario15;
  ...
  private ActivityRatatouilleDescargaBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario15, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario15 = imageButtonUsuario15;
  ...
  @NonNull
  public static ActivityRatatouilleDescargaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRatatouilleDescargaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_ratatouille_descarga, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRatatouilleDescargaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario15;
      ImageButton imageButtonUsuario15 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario15 == null) {
        break missingId;
      }
      ...
      return new ActivityRatatouilleDescargaBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario15, imageView7, textView8, textView9);
    }
