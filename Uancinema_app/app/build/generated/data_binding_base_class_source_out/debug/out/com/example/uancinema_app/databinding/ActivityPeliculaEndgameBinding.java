...
public final class ActivityPeliculaEndgameBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario2;
  ...
  private ActivityPeliculaEndgameBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario2, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario2 = imageButtonUsuario2;
  ...
  @NonNull
  public static ActivityPeliculaEndgameBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPeliculaEndgameBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_pelicula_endgame, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPeliculaEndgameBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario2;
      ImageButton imageButtonUsuario2 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario2 == null) {
        break missingId;
      }
      ...
      return new ActivityPeliculaEndgameBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario2, imageView7, textView8, textView9);
    }
