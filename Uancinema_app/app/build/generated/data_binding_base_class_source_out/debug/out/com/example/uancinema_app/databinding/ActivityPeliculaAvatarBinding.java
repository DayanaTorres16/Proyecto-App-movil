...
public final class ActivityPeliculaAvatarBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario20;
  ...
  private ActivityPeliculaAvatarBinding(@NonNull ConstraintLayout rootView, @NonNull Button button5,
      ...
      @NonNull ImageButton imageButtonUsuario20, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario20 = imageButtonUsuario20;
  ...
  @NonNull
  public static ActivityPeliculaAvatarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPeliculaAvatarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_pelicula_avatar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPeliculaAvatarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario20;
      ImageButton imageButtonUsuario20 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario20 == null) {
        break missingId;
      }
      ...
      return new ActivityPeliculaAvatarBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario20, imageView7, textView8, textView9);
    }
