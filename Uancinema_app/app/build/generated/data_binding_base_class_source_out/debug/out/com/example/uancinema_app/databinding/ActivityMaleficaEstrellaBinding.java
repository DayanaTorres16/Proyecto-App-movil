...
public final class ActivityMaleficaEstrellaBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario19;
  ...
  private ActivityMaleficaEstrellaBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario19, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario19 = imageButtonUsuario19;
  ...
  @NonNull
  public static ActivityMaleficaEstrellaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMaleficaEstrellaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_malefica_estrella, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMaleficaEstrellaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario19;
      ImageButton imageButtonUsuario19 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario19 == null) {
        break missingId;
      }
      ...
      return new ActivityMaleficaEstrellaBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario19, imageView7, textView8, textView9);
    }
