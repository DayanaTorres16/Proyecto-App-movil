...
public final class ActivityRatatouilleEstrellaBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario16;
  ...
  private ActivityRatatouilleEstrellaBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario16, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario16 = imageButtonUsuario16;
  ...
  @NonNull
  public static ActivityRatatouilleEstrellaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRatatouilleEstrellaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_ratatouille_estrella, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRatatouilleEstrellaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario16;
      ImageButton imageButtonUsuario16 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario16 == null) {
        break missingId;
      }
      ...
      return new ActivityRatatouilleEstrellaBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario16, imageView7, textView8, textView9);
    }
