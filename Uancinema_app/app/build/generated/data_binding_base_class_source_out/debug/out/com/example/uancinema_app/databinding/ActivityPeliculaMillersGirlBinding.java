...
public final class ActivityPeliculaMillersGirlBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario8;
  ...
  private ActivityPeliculaMillersGirlBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario8, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario8 = imageButtonUsuario8;
  ...
  @NonNull
  public static ActivityPeliculaMillersGirlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPeliculaMillersGirlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_pelicula_millers_girl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPeliculaMillersGirlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario8;
      ImageButton imageButtonUsuario8 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario8 == null) {
        break missingId;
      }
      ...
      return new ActivityPeliculaMillersGirlBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario8, imageView7, textView8, textView9);
    }
