...
public final class ActivityMillersEstrellaBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario10;
  ...
  private ActivityMillersEstrellaBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario10, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario10 = imageButtonUsuario10;
  ...
  @NonNull
  public static ActivityMillersEstrellaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMillersEstrellaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_millers_estrella, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMillersEstrellaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario10;
      ImageButton imageButtonUsuario10 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario10 == null) {
        break missingId;
      }
      ...
      return new ActivityMillersEstrellaBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario10, imageView7, textView8, textView9);
    }
