...
public final class ActivityAvatarEstrellaBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario22;
  ...
  private ActivityAvatarEstrellaBinding(@NonNull ConstraintLayout rootView, @NonNull Button button5,
      ...
      @NonNull ImageButton imageButtonUsuario22, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario22 = imageButtonUsuario22;
  ...
  @NonNull
  public static ActivityAvatarEstrellaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAvatarEstrellaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_avatar_estrella, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAvatarEstrellaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario22;
      ImageButton imageButtonUsuario22 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario22 == null) {
        break missingId;
      }
      ...
      return new ActivityAvatarEstrellaBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario22, imageView7, textView8, textView9);
    }
