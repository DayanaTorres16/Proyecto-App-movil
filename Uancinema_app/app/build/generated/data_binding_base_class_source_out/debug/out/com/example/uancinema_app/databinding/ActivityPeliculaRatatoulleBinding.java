...
public final class ActivityPeliculaRatatoulleBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario14;
  ...
  private ActivityPeliculaRatatoulleBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario14, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario14 = imageButtonUsuario14;
  ...
  @NonNull
  public static ActivityPeliculaRatatoulleBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPeliculaRatatoulleBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_pelicula_ratatoulle, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPeliculaRatatoulleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario14;
      ImageButton imageButtonUsuario14 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario14 == null) {
        break missingId;
      }
      ...
      return new ActivityPeliculaRatatoulleBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario14, imageView7, textView8, textView9);
    }
