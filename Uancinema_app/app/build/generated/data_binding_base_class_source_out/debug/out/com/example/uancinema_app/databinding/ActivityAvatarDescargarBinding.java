...
public final class ActivityAvatarDescargarBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario21;
  ...
  private ActivityAvatarDescargarBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario21, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario21 = imageButtonUsuario21;
  ...
  @NonNull
  public static ActivityAvatarDescargarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAvatarDescargarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_avatar_descargar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAvatarDescargarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario21;
      ImageButton imageButtonUsuario21 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario21 == null) {
        break missingId;
      }
      ...
      return new ActivityAvatarDescargarBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario21, imageView7, textView8, textView9);
    }
