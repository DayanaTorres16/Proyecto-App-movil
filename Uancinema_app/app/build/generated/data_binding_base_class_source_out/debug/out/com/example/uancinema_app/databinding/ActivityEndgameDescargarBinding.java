...
public final class ActivityEndgameDescargarBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario3;
  ...
  private ActivityEndgameDescargarBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario3, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario3 = imageButtonUsuario3;
  ...
  @NonNull
  public static ActivityEndgameDescargarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityEndgameDescargarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_endgame_descargar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityEndgameDescargarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario3;
      ImageButton imageButtonUsuario3 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario3 == null) {
        break missingId;
      }
      ...
      return new ActivityEndgameDescargarBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario3, imageView7, textView8, textView9);
    }
