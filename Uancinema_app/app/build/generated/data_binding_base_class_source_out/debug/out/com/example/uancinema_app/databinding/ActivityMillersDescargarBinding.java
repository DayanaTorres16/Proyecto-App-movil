...
public final class ActivityMillersDescargarBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario9;
  ...
  private ActivityMillersDescargarBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario9, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario9 = imageButtonUsuario9;
  ...
  @NonNull
  public static ActivityMillersDescargarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMillersDescargarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_millers_descargar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMillersDescargarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario9;
      ImageButton imageButtonUsuario9 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario9 == null) {
        break missingId;
      }
      ...
      return new ActivityMillersDescargarBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario9, imageView7, textView8, textView9);
    }
