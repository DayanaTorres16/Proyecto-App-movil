...
public final class ActivityEngameEstrellaBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario4;
  ...
  private ActivityEngameEstrellaBinding(@NonNull ConstraintLayout rootView, @NonNull Button button5,
      ...
      @NonNull ImageButton imageButtonUsuario4, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario4 = imageButtonUsuario4;
  ...
  @NonNull
  public static ActivityEngameEstrellaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityEngameEstrellaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_engame_estrella, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityEngameEstrellaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario4;
      ImageButton imageButtonUsuario4 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario4 == null) {
        break missingId;
      }
      ...
      return new ActivityEngameEstrellaBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario4, imageView7, textView8, textView9);
    }
