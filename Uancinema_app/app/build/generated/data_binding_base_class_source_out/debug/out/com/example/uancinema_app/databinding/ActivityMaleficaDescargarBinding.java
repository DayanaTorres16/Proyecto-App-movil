...
public final class ActivityMaleficaDescargarBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario18;
  ...
  private ActivityMaleficaDescargarBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario18, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario18 = imageButtonUsuario18;
  ...
  @NonNull
  public static ActivityMaleficaDescargarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMaleficaDescargarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_malefica_descargar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMaleficaDescargarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario18;
      ImageButton imageButtonUsuario18 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario18 == null) {
        break missingId;
      }
      ...
      return new ActivityMaleficaDescargarBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario18, imageView7, textView8, textView9);
    }
