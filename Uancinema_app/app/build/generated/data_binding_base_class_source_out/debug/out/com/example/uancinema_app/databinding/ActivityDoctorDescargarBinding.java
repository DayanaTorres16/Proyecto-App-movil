...
public final class ActivityDoctorDescargarBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton imageButtonUsuario6;
  ...
  private ActivityDoctorDescargarBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageButton imageButtonUsuario6, @NonNull ImageView imageView7,
    ...
    this.imageButtonUsuario6 = imageButtonUsuario6;
  ...
  @NonNull
  public static ActivityDoctorDescargarBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDoctorDescargarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_doctor_descargar, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDoctorDescargarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.imageButtonUsuario6;
      ImageButton imageButtonUsuario6 = ViewBindings.findChildViewById(rootView, id);
      if (imageButtonUsuario6 == null) {
        break missingId;
      }
      ...
      return new ActivityDoctorDescargarBinding((ConstraintLayout) rootView, button5, button6,
          imageButton20, imageButton24, imageButton25, imageButton26, imageButton27,
          imageButtonUsuario6, imageView7, textView8, textView9);
    }
